...
df.to_csv('/Users/stevenchan/Documents/TECHX_2019/Private/Assignment-Solutions/Assignment2/dataset/assignment-ramen-ratings.csv', index=False) #save file to_csv
...
baby_dog = cv2.imread('/Users/stevenchan/Documents/TECHX_2019/Private/Assignment-Solutions/Assignment2/dataset/baby-dog.jpg')
baby_dog = cv2.cvtColor(baby_dog, cv2.COLOR_BGR2RGB)
star_boo = cv2.imread('/Users/stevenchan/Documents/TECHX_2019/Private/Assignment-Solutions/Assignment2/dataset/star-boo.jpg')
star_boo = cv2.cvtColor(star_boo, cv2.COLOR_BGR2RGB)
chihuahua = cv2.imread('/Users/stevenchan/Documents/TECHX_2019/Private/Assignment-Solutions/Assignment2/dataset/chihuahua.jpg')
